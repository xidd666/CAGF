...
from transformers import RobertaModel, HubertModel, WavLMModel
...
class rob_wavlm_cc(nn.Module):            
    ...
    def forward(self, text_inputs, text_mask, audio_inputs, audio_mask):
        ...
        A_features = torch.stack(A_features,0).to(audio_inputs.device)
